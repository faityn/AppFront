        ...
        <Layout type="main">
            ...
            <div className="mx-auto max-w-[1224px] mt-[100px] mb-[150px] whitespace-pre-line break-keep">
                ...
                <div className="mt-10 max-md:px-4 ">
                    <div className="text-2xl max-sm:text-md text-[#767676] font-light text-center">
                        {locale === "kr" ? (
                            <div>
                                (주)에이피피는 첫째도 둘째도 셋째도{" "}
                                ...
                                기업입니다. 사람과 꿈과 기술은 따로 분리할 수
                                있는 게 아닙니다. <br />
                                꿈 안에 사람이 있고, 기술 안에 꿈이 있고 사람이
                                있습니다. 사람을 먼저 생각하면 꿈이 보이고,
                                기술이 보입니다.
                                <br />
                                <span className="text-black font-medium">
                                    (주)에이피피에서 당신의 꿈을 펼쳐보시기
                                    바랍니다.
                                </span>
                                <br />
                            </div>
                            ...
                            <div>
                                ...
                                first, second, and third. People, dreams, and
                                technology cannot be separated. <br />
                                There are people in dreams, and dreams and
                                people in technology. If you think of people
                                first, you will see dreams and technology.
                                <br />
                                <span className="text-black font-medium">
                                    We hope you will unfold your dreams at APP
                                    Co., Ltd.
                                </span>
                                <br />
                            </div>
                            ...
                            <div className=" grid grid-cols-12 gap-5 bg-white">
                                {itemList?.map((item, index) => {
                                    return (
                                        <div
                                            key={index}
                                            className="col-span-3 max-lg:col-span-6"
                                        >
